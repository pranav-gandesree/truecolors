...
//       <NavMenu click={click}>
//         <NavItem>
//           <NavLinkItem to="/" activeClassName="active" onClick={closeMenu}>
//             <h4>Home</h4>
//           </NavLinkItem>
//         </NavItem>
//         <NavItem>
//           <NavLinkItem to="/about" activeClassName="active" onClick={closeMenu}>
//             <h4>About Us</h4>
//           </NavLinkItem>
//         </NavItem>
//         <NavItem>
//           <NavLinkItem to="/gallery" activeClassName="active" onClick={closeMenu}>
//             <h4>Gallery</h4>
//           </NavLinkItem>
//         </NavItem>
//         <NavItem>
//           <NavLinkItem to="/contact" activeClassName="active" onClick={closeMenu}>
//             <h4>Contact Us</h4>
//           </NavLinkItem>
//         </NavItem>
//       </NavMenu>
